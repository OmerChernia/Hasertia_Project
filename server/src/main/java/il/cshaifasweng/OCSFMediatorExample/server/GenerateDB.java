...
public class GenerateDB {
    ...
    private void generateMovies() {
        ...
        if (movies.isEmpty()) {
            movies = List.of(
                    new Movie( "קפטן אמריקה", "Steve Rogers, a rejected military soldier transforms into Captain America after taking a dose of a 'Super-Soldier serum'.", "Marvel Studios", "Captain America", List.of("Chris Evans", "Sebastian Stan", "Hayley Atwell"), "captainamerica.jpg", Movie.StreamingType.BOTH, 124, 50, 60, "action",false),
                    ...
                    new Movie( "מופאסה: מלך האריות", "A prequel to The Lion King focusing on Mufasa's journey to become king.", "Walt Disney Pictures", "Mufasa: The Lion King", List.of("James Earl Jones", "Donald Glover", "Beyoncé"), "mufasa-the-lion-king.jpg", Movie.StreamingType.BOTH, 120, 50, 60, "animation",true),
                    ...
                    new Movie( "פינוקיו", "A live-action adaptation of the classic tale of a wooden puppet who wants to become a real boy.", "Walt Disney Pictures", "Pinocchio", List.of("Tom Hanks", "Benjamin Evan Ainsworth", "Joseph Gordon-Levitt"), "pinocchio.jpg", Movie.StreamingType.BOTH, 105, 50, 60, "fantasy",true),
                    ...
                    new Movie( "מלחמת הכוכבים: פרק 1 - אימת הפאנטום", "The origin story of Anakin Skywalker and the rise of the Sith.", "Lucasfilm", "Star Wars: Episode I - The Phantom Menace", List.of("Liam Neeson", "Ewan McGregor", "Natalie Portman"), "Star_Wars_Episode_1.jpg", Movie.StreamingType.BOTH, 136, 50, 60, "sci-fi",true),
                    ...
                    new Movie( "ברבי", "To live in Barbie Land is to be a perfect being in a perfect place. Unless you have a full-on existential crisis. Or you’re a Ken.", "Warner Bros.", "Barbie", List.of("Margot Robbie", "Ryan Gosling", "Simu Liu"), "Barbie.jpg", Movie.StreamingType.BOTH, 114, 50, 60, "comedy",true),
